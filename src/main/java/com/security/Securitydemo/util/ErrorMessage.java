...
public class ErrorMessage {
    ...
    public static String INVALID_PASSWORD = "Invalid password! Please Enter Valid Password , Password must be min 6 , max 10 character!";
    public static String PASSWORD_NOT_NULL = "User password can not be empty! Please Enter Valid Password";
